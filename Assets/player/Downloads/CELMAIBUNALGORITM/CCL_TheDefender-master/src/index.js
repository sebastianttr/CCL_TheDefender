...
const initGame = () => {
    let gameWorks = new Cue({
        ...
        init(){
            ...
            gameObjects.push(new Vehicle(600, 170, this.assets.vehicle1.width, this.assets.vehicle1.height, this.assets.vehicle1))
            gameObjects.push(new Vehicle(900, 250, this.assets.vehicle1.width, this.assets.vehicle1.height, this.assets.vehicle1))
            gameObjects.push(new Vehicle(1200, 370, this.assets.vehicle1.width, this.assets.vehicle1.height, this.assets.vehicle1))
